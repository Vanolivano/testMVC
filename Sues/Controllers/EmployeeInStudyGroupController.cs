...
{
    using Sues.Domain;
    using Sues.Models.EmployeeInStudyGroup;
    ...
    public class EmployeeInStudyGroupController : Controller
    {
        ...
        public EmployeeInStudyGroupController()
        {
        ...
        public ActionResult Delete(int id, string returnUrl)
        {
            ...
            _employeeInStudyGroupRepository.Delete(id);
            return Redirect(returnUrl);
        }
        [HttpGet]
        public ActionResult Add(int studyGroupId, string returnUrl)
        {
            IEnumerable<Employee> employeeList = _employeeRepository.Select(new EmployeeFilter { });
            ...
            foreach (var item in employeeList)
            {
                ...
                employeeSelectList.Add(selectedElement);
            }
            var model = new EmployeeInStudyGroupEditModel
            {
